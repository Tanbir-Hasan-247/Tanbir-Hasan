const cord = document.getElementById('pull-cord');
        ...
        function toggleApp() {
            ...
            if (isOn) {
                ...
                mouth.setAttribute('d', "M90 85 Q100 100 110 85"); // Smile
                mouth.setAttribute('stroke', '#ff4d4d');
                content.classList.remove('dimmed');
                content.classList.add('illuminated');
                
                // Show Alert, Hide Hint
                ...
                mouth.setAttribute('d', "M90 95 Q100 85 110 95"); // Sad
                mouth.setAttribute('stroke', '#000');
                content.classList.add('dimmed');
                content.classList.remove('illuminated');
                
                // Hide Alert, Show Hint
